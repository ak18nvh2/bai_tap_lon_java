...
public class SettingScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(110, 170, 291, 72);
        ...
        jButton2.setBounds(110, 270, 291, 72);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlykitucxa/images/logo_login_SMALL.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(190, 40, 130, 100);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quanlykitucxa/images/bg_main.png"))); // NOI18N
        ...
        jButton3.setBounds(190, 370, 120, 30);

        setBounds(0, 0, 521, 468);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int x = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn đăng xuất?", "Thông báo", JOptionPane.YES_NO_OPTION);
        if (x == 0) {
            this.dispose();
